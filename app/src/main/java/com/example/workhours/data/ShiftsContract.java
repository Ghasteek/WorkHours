...
public final class ShiftsContract {
    ...
    public static final class ShiftEntry implements BaseColumns{
        ...
        public final static Uri CONTENT_URI_MONTHS = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_MONTHS);
        ...
        public static final String CONTENT_LIST_TYPE_MONTHS = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + ShiftsContract.CONTENT_AUTHORITY + "/" + ShiftsContract.PATH_MONTHS;
        public static final String CONTENT_ITEM_TYPE_MONTHS = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + ShiftsContract.CONTENT_AUTHORITY + "/" + ShiftsContract.PATH_MONTHS;

        public final static String TABLE_NAME = "shifts";
        public final static String TABLE_MONTHS_NAME = "months";
        ...
        public final static String _ID_MONTHS = BaseColumns._ID;               //integer
        public final static String COLUMN_DATE_MONTHS = "date";                //integer, date in format RRRRMMDD
        public final static String COLUMN_OVERTIMESUM_MONTHS = "overtimeSum";          //integer, time of arrival in seconds
